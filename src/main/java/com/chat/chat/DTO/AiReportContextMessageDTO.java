...
public class AiReportContextMessageDTO {
    ...
    public boolean isEsUsuarioDenunciado() {
        return esUsuarioDenunciado;
    }

    public void setEsUsuarioDenunciado(boolean esUsuarioDenunciado) {
        this.esUsuarioDenunciado = esUsuarioDenunciado;
    }
