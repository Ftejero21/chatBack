...
public interface MensajeProgramadoRepository extends JpaRepository<MensajeProgramadoEntity, Long> {
    ...
    Page<MensajeProgramadoEntity> findByCreatedByIdOrderByScheduledAtAscIdAsc(Long createdById, Pageable pageable);

    Page<MensajeProgramadoEntity> findByCreatedByIdOrderByIdDesc(Long createdById, Pageable pageable);

    Page<MensajeProgramadoEntity> findByCreatedByIdAndStatusOrderByIdDesc(Long createdById,
                                                                           EstadoMensajeProgramado status,
                                                                           Pageable pageable);

    long countByCreatedByIdAndStatusIn(Long createdById, Collection<EstadoMensajeProgramado> statuses);
